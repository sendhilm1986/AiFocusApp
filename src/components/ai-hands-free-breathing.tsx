          ...
          <div className="w-full max-w-2xl text-center">
            ...
            <form onSubmit={handleMoodSubmit} className="flex flex-col items-center gap-4">
              <Input
                ...
                className="bg-transparent border-0 border-b-2 border-input rounded-none focus-visible:ring-0 focus-visible:ring-offset-0 text-center text-3xl font-heading h-20 w-full placeholder:text-3xl placeholder:font-heading"
                autoFocus
              />

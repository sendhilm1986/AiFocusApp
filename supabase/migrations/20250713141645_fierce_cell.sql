/*
  # Clean Database Schema for Clarity & Peace App
  ...
  2. Security
    ...
    - Simple, working policies for authenticated users
    - Proper admin access without restrictions

  3. Functions
    - Working admin check function
    - Clean user management functions
*/
...
DROP FUNCTION IF EXISTS update_user_status(uuid, boolean);

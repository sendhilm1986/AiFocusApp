/*
  # Clean Setup for Fresh Supabase Instance
  
  This migration safely sets up the database schema, handling any existing objects.
...
DROP POLICY IF EXISTS "Admin can delete any stress entries" ON stress_entries;
DROP POLICY IF EXISTS "Admin can see all stress entries" ON stress_entries;
DROP POLICY IF EXISTS "Users can manage own stress entries" ON stress_entries;
...
DROP POLICY IF EXISTS "Admin can manage music settings" ON exercise_music_settings;
DROP POLICY IF EXISTS "Everyone can view music settings" ON exercise_music_settings;
DROP POLICY IF EXISTS "Admin can manage background music" ON background_music;
DROP POLICY IF EXISTS "Everyone can view active background music" ON background_music;
...
-- RLS Policies for stress entries
...
-- RLS Policies for background music
...
-- RLS Policies for exercise music settings
